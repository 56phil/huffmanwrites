#!/usr/bin/env python3
"""Generate the 'wpw' Stoic Backgammon board position with a golden haze overlay."""
import os
...
# POSITION: 2w2 2b4 2b5 3b6 2b7 2b8 1b9 2b13 1w14 2w17 2w18 2w19 2w20 2w21 2w22 1b24
POSITION = [
    (2, 2, 'w'), (4, 2, 'b'), (5, 2, 'b'), (6, 3, 'b'), (7, 2, 'b'), 
    (8, 2, 'b'), (9, 1, 'b'), (13, 2, 'b'), (14, 1, 'w'), (17, 2, 'w'), 
    (18, 2, 'w'), (19, 2, 'w'), (20, 2, 'w'), (21, 2, 'w'), (22, 2, 'w'), (24, 1, 'b'),
]
...
l.save(f"{OUT}/wpw 16x9.png")
p.save(f"{OUT}/wpw 4x5.png")
print("Saved wpw images with golden haze")
