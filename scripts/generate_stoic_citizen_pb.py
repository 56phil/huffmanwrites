#!/usr/bin/env python3
"""
Book Cover Generator Toolkit - "The Stoic Citizen" Paperback Edition
Dimensions: 6" x 9" Trim, 135 Pages.
"""
...
class BookCoverGenerator:
    def __init__(self, page_count=135): 
        self.TRIM_W = 6.0
        self.TRIM_H = 9.0
        self.BLEED = 0.125
        self.DPI = 300
    ...
    def generate(self, output_png="stoic_citizen_pb_cover.png", output_pdf="stoic_citizen_pb_kdp.pdf"):
        ...
        v_coords = [
            (self.front_left + v_margin, self.bleed_px + v_margin),
            (self.front_right - v_margin, self.bleed_px + v_margin),
            (self.front_left + v_margin, self.bleed_px + self.trim_h_px - v_margin),
            (self.front_right - v_margin, self.bleed_px + self.trim_h_px - v_margin),
        ]
...
if __name__ == "__main__":
    ...
    gen.generate()
    print("The Stoic Citizen PB Cover generated successfully.")
