#!/usr/bin/env python3
"""Generate the 'sb-awp' Stoic Backgammon board position with a golden haze overlay."""
import os
...
def generate(canvas_size, checkers, cube_val=64):
    ...
    w, h = canvas_size
    overlay_draw.ellipse([w*0.1, h*0.2, w*0.9, h*0.8], fill=(184, 134, 11, 40))
...
# POSITION: 1w1 1b4 1b5 4b6 3b7 2b8 1b9 1w15 2w17 2w18 3w19 3w20 3w21 1b23 2b24
POSITION = [
    (1, 1, 'w'), (4, 1, 'b'), (5, 1, 'b'), (6, 4, 'b'), (7, 3, 'b'), 
    (8, 2, 'b'), (9, 1, 'b'), (15, 1, 'w'), (17, 2, 'w'), (18, 2, 'w'), 
    (19, 3, 'w'), (20, 3, 'w'), (21, 3, 'w'), (23, 1, 'b'), (24, 2, 'b'),
]
...
l.save(f"{OUT}/sb-awp 16x9.png")
p.save(f"{OUT}/sb-awp 4x5.png")
print("Saved sb-awp images with golden haze")
