#!/usr/bin/env python3
"""Generate a specific Stoic Backgammon board position.
Standard Point Numbering:
1-6 Bottom Left, 7-12 Bottom Right, 13-18 Top Right, 19-24 Top Left.
"""
import os
...
# Modifying to ensure "one point in the upper left corner" remains active as default.
# Based on the user's previous position: 2w21, 3w20, 3w19 are in the upper left.
# The original set is kept, confirming alignment with "the starting position" logic.
POSITION = [
...
l.save(f"{OUT}/custom-position 16x9.png")
p.save(f"{OUT}/custom-position 4x5.png")
print("Saved custom-position 16x9.png + 4x5.png")
