#!/usr/bin/env python3
"""Generate the 'sb-twa' Stoic Backgammon board position with a golden haze overlay."""
import os
...
# POSITION: 2w1 2w3 2b4 2b5 3b6 2b7 2b8 1b9 2b13 1w15 2w18 3w19 2w20 3w21 1b24
POSITION = [
    (1, 2, 'w'), (3, 2, 'w'), (4, 2, 'b'), (5, 2, 'b'), (6, 3, 'b'), 
    (7, 2, 'b'), (8, 2, 'b'), (9, 1, 'b'), (13, 2, 'b'), (15, 1, 'w'), 
    (18, 2, 'w'), (19, 3, 'w'), (20, 2, 'w'), (21, 3, 'w'), (24, 1, 'b'),
]
...
l.save(f"{OUT}/sb-twa 16x9.png")
p.save(f"{OUT}/sb-twa 4x5.png")
print("Saved sb-twa images with golden haze")
