#!/usr/bin/env python3
"""Generate the custom Stoic Backgammon board position."""
import os
...
# POSITION: 2w1 2b4 4b6 4b8 2b9 1b10 2w12 2w17 2w18 3w19 3w20 2w21 2b24
POSITION = [
    (1, 2, 'w'), (4, 2, 'b'), (6, 4, 'b'), (8, 4, 'b'), (9, 2, 'b'), 
    (10, 1, 'b'), (12, 2, 'w'), (17, 2, 'w'), (18, 2, 'w'), (19, 3, 'w'), 
    (20, 3, 'w'), (21, 2, 'w'), (24, 2, 'b'),
]
...
l.save(f"{OUT}/custom-pos-2.png")
p.save(f"{OUT}/custom-pos-2.png") # Note: a bit of a typo in the filename logic but I'll just save them uniquely if needed.
# Actually let's fix the filenames to be consistent.
l.save(f"{OUT}/custom-pos-2-16x9.png")
p.save(f"{OUT}/custom-pos-2-4x5.png")
print("Saved custom-pos-2 images")
