#!/usr/bin/env python3
"""Generate the 'sb-gtl' Stoic Backgammon board position with a golden haze overlay."""
import os
...
def generate(canvas_size, checkers, cube_val=64):
    ...
    # Downscale first for better haze blending
    final_img = img.resize(canvas_size, Image.Resampling.LANCZOS)
    
    # Create the Golden Haze overlay
    # Using a gradient or a soft radial glow
    haze = Image.new('RGB', canvas_size, (0,0,0))
    haze_draw = ImageDraw.Draw(haze)
    
    # Simulate a large soft glow in the center
    # Since we can't do real gradients easily in PIL Draw, we'll use a series of transparent circles 
    # Or simpler: a low-alpha gold layer with a gaussian blur.
    # Creating a semi-transparent Gold layer
    overlay = Image.new('RGBA', canvas_size, (0,0,0,0))
    overlay_draw = ImageDraw.Draw(overlay)
    
    # Draw a large soft golden ellipse across the center to create the 'haze'
    # Range from center towards corners.
    w, h = canvas_size
    overlay_draw.ellipse([w*0.1, h*0.2, w*0.9, h*0.8], fill=(184, 134, 11, 40)) # Soft goldS with low alpha
    
    # Blur the haze for softness
...
# POSITION: 1w1 2b4 1b5 3b6 2b7 3b8 2b9 1w12 1w14 2w17 2w18 3w19 2w20 3w21 2b24
POSITION = [
    (1, 1, 'w'), (4, 2, 'b'), (5, 1, 'b'), (6, 3, 'b'), (7, 2, 'b'), 
    (8, 3, 'b'), (9, 2, 'b'), (12, 1, 'w'), (14, 1, 'w'), (17, 2, 'w'), 
    (18, 2, 'w'), (19, 3, 'w'), (20, 2, 'w'), (21, 3, 'w'), (24, 2, 'b'),
]
...
l.save(f"{OUT}/sb-gtl 16x9.png")
p.save(f"{OUT}/sb-gtl 4x5.png")
print("Saved sb-gtl images with golden haze")
