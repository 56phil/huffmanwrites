...
1. **Be proactive** — The space between stimulus and response is where human freedom lives. Proactivity is not optimism; it is the refusal to let circumstances determine your behavior. Covey's term for the opposite: reactive living, where mood follows weather and behavior follows provocation.
2. **Begin with the end in mind** — All things are created twice: first in the mind, then in the world. Without a personal mission — a clear sense of what matters and why — you spend your energy efficiently executing someone else's priorities.
3. **Put first things first** — The famous time-management matrix: urgent vs. important. Most people live in Quadrant I (urgent and important, crisis mode) or Quadrant IV (neither, distraction). Effectiveness lives in Quadrant II: not urgent, but important. Planning, relationship-building, preparation. The things that prevent crises if you do them, and create them if you don't.
